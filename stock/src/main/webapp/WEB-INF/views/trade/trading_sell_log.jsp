...
<!-- 
* File name : trading_log.jsp(매매일지-매도)
* Author : swm
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
		...
		<div class="container-fluid">
			<!-- Page Heading -->
			<h1 class="h3 mb-2 text-gray-800">매매일지 작성(매도)</h1>
			<p class="mb-4">
                ...
                <div class="table-responsive">
			        <div class="card-body">
			                <div class="row">
			                	...
			                	<div class="col-md-2 col-lg-2">
			                        <div class="form-group">
			                            <label class="control-label">매도수량</label>
			                            <input type="text" class="form-control" id="sell_quantity" numberonly="true" placeholder="단위(주)" onchange="priceCheck()" />
			                        </div>
			                    </div>	             
			                </div>
			                <div class="row">
			                	<div class="col-md-2 col-lg-2">
			                        <div class="form-group">
			                            <label class="control-label">매도단가</label>
			                            <input type="text" class="form-control" id="sell_unit_price" numberonly="true" placeholder="단위(주)" onchange="priceCheck()" />
			                        </div>
			                    </div>	
			                    <div class="col-md-2 col-lg-2">
			                        <div class="form-group">
			                            <label class="control-label">매도 수수료(세금포함)</label>
			                            <input type="text" class="form-control" id="sell_fees" numberonly="true" placeholder="단위(원)" />
			                        </div>
			                    </div>
			                    <div class="col-md-2 col-lg-2">
			                        <div class="form-group">
			                            <label class="control-label">매도금액</label>
			                            <input type="text" class="form-control" id="sell_price" numberonly="true" placeholder="단위(원)" />
			                        </div>
			                    </div>
			                </div>
			                <button class="btn btn-primary btn-icon-split" id="trade_save" style="float: right;" onclick="tradeSave(0)">
